...
pub const RENDEZVOUS_SERVERS: &[&str] = &["ca.shaoxiaorustdesk.cn"];
pub const PUBLIC_RS_PUB_KEY: &str = "O3cEF/SHYWsln5QfqUp99vUUWVRWhVZHmwkqn/dKtqiMubXXxGvC5+VpPeQOEBAmgaXaU5k1t8+PIBIhvoEnug==";
